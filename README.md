...
Firestore Rules까지 자동 배포하려면 이 서비스 계정에 Firebase Hosting 배포 권한 외에 Firebase Rules Admin 권한도 필요합니다. 권한이 없으면 Hosting 배포는 먼저 완료되더라도 Firestore Rules 단계에서 Actions가 실패합니다.
